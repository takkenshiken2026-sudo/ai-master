...
FLOWS: dict[str, FlowSpec] = {
    ...
    "ai-certs-for-finance": FlowSpec(
        title="金融業界のAI資格活用フロー",
        subtitle="コンプライアンスと業務へ接続する",
        steps=[
            ("01", "業態", "整理", "銀行証券等"),
            ("02", "第1", "資格", "選定"),
            ("03", "学習", "・合格", ""),
        ...
        highlight_index=3,
        loop_caption="統制確認で次の学習へ",
    ),
    "ai-certs-for-manufacturing": FlowSpec(
        title="製造業のAI資格活用フロー",
        subtitle="現場DXと業務へ接続する",
        steps=[
            ("01", "現場", "整理", "工程・課題"),
            ("02", "第1", "資格", "選定"),
            ("03", "学習", "・合格", ""),
        ...
        highlight_index=3,
        loop_caption="安全確認で次の学習へ",
    ),
    "ai-certs-for-healthcare": FlowSpec(
        title="医療・ヘルスケアのAI資格活用フロー",
        subtitle="コンプライアンスと業務へ接続する",
        steps=[
            ("01", "業態", "整理", "病院薬局等"),
            ("02", "第1", "資格", "選定"),
    ...
    "ai-certs-for-education": FlowSpec(
        title="教育業界のAI資格活用フロー",
        subtitle="学びの現場と業務へ接続する",
        steps=[
            ("01", "業態", "整理", "学校塾等"),
            ("02", "第1", "資格", "選定"),
            ("03", "学習", "・合格", ""),
    ...
    "ai-certs-for-public-sector": FlowSpec(
        title="公共・行政のAI資格活用フロー",
        subtitle="コンプライアンスと業務へ接続する",
        steps=[
            ("01", "業態", "整理", "国地方等"),
            ("02", "第1", "資格", "選定"),
